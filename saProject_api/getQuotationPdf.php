<?php
    ...
    $quotationId = isset($_GET['quotationId']) ? $_GET['quotationId'] : '';
    ...
    $pdf->Ln(5);
    $pdf->Cell(140, 10, 'Remark', 1);
    $pdf->Cell(50, 10, 'Grand Total', 1, 1, 'C');
    $pdf->Cell(140, 10, '', 1);
    $pdf->Cell(50, 10, number_format($totalAmount, 2), 1, 1, 'C');
    
    $pdf->Ln(5);
    $pdf->Cell(170, 10, 'Signature', 0, 1, 'R');
    $pdf->Ln(10);
    $pdf->Cell(175, 10, '.......................', 0, 1, 'R');
    
    ob_end_clean();
    $pdf->Output('D', "quotation_$quotationId.pdf"); 
